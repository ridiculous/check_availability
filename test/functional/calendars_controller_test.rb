...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { dates: @calendar.dates, refresh_date: @calendar.refresh_date, unit_id: @calendar.unit_id }
    end
  ...
  test "should update calendar" do
    put :update, id: @calendar, calendar: { dates: @calendar.dates, refresh_date: @calendar.refresh_date, unit_id: @calendar.unit_id }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
